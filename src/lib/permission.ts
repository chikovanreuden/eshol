...
export const getShoppinglistPermission = async (spl: Shoppinglist | ICiShoppinglistEntity["splUid"], user: User | ICiUserEntity["userUid"]): Promise<ICiShoppinglistMemberEntity["permission"] | "owner" | null> => {
